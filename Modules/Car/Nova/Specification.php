...
class Specification extends Resource
{
     ...
     *
     * @var class-string<\Modules\Car\Entities\Specification>
     */
    public static $model = \Modules\Car\Entities\Specification::class;
     ...
     * @var string
     */
    public static $title = 'specification_name';
